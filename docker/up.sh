...
cleos push action eosio.token create '{"issuer":"eosio.token", "maximum_supply": "1000000.000 PHI", "can_freeze": 0, "can_recall": 0, "can_whitelist": 0}' -p eosio.token@active
cleos push action eosio.token issue '{"to":"inita", "quantity": "100000.000 PHI", "memo": ""}' -p eosio.token@active
cleos push action eosio.token issue '{"to":"initb", "quantity": "100000.000 PHI", "memo": ""}' -p eosio.token@active
