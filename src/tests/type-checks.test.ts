...
describe('Chain API Plugin Endpoints', () => {
    ...
    it('validates return type of get_contract_query', async () => {
        ...
        const result: GetContractQueryResult = await rpc.get_contract_query('readonly', transaction);
        const getContractQueryResult: any = {
            head_block_num: 'number',
        ...
        verifyType(result, getContractQueryResult);
    });
