...
export class Api {
    ...
    constructor(args: {
        ...
        // Note: transactionAbi is missing: actions, tables, ricardian_clauses, error_messages, abi_extensions
        // which was obscured by using require() which cast it to `any`.
...
class ActionSerializer implements ActionSerializerType {
    constructor(parent: ActionBuilder, api: Api, accountName: string, authorization: ser.Authorization[]) {
